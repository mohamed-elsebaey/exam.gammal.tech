...
function Exam({
  ...
  return (
    <div className="container flex gap-4 flex-wrap justify-center items-start">
      ...
      <div className="w-[100%] overflow-auto sm:w-[85%] md:w-[70%] lg:w-96 bg-[#282c34] p-4 rounded-md select-none text-white h-[532px] max-h-[532px] text-center flex flex-col gap-4">
        <h1 className="py-4">{questionNumberInQuiz}</h1>
        <hr />
